...
if __name__ == "__main__":
    ...
    output_file='./largestclustersizevstime_data/volfracribo'+str(volume_fraction_ribosome)+'_Tc'+str(crowder_temperature)+'_eps'+str(epsilon)+'_medianlargestclustersize.data'
